...
Sub SALVAR()
    ...
    wsGuiaExames.Range("AC5:AG5").Copy
    wsBancoDeDados.Range("B5").Value = wsBancoDeDados.Range("B6").Value + 1
    wsBancoDeDados.Range("C5:G5").PasteSpecial Paste:=xlPasteValues
...
Sub NOVO()
    ...
    Range("B12").Value = Range("AD6").Value
    LIMPAR
